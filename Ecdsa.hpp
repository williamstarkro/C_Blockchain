 ...
 */
#ifndef C_TUT_ECDSA_HPP
#define C_TUT_ECDSA_HPP
...
public: static string sign(const Uint256 &privateKey, const Sha256Hash &msgHash, const Uint256 &nonce, Uint256 &outR, Uint256 &outS);
